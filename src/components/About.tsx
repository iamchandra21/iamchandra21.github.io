        ...
        <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="grid gap-6">
              {focusAreas.map((area, index) => {
                ...
                return (
                  <div
                    key={area.title}
                    className={`glass-card rounded-2xl p-6 flex gap-4 hover-shadow-${area.color}`}
                  >
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="glass-card rounded-2xl p-8 text-center hover-shadow-primary">
                <div className="text-5xl font-bold gradient-text mb-2">3+</div>
                <div className="text-foreground/60">Years Experience</div>
              </div>
              <div className="glass-card rounded-2xl p-8 text-center hover-shadow-cyan">
